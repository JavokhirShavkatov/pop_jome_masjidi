...
import com.example.popjomemasjidi.Compass;
import com.example.popjomemasjidi.GPSTracker;
...
public class CompassActivity extends AppCompatActivity {
    ...
    private void setupCompass() {
        ...
        Compass.CompassListener cl = azimuth -> { adjustGambarDial(azimuth); adjustArrowQiblat(azimuth); };
    ...
    public void fetch_GPS(){
        ...
        if(gps.canGetLocation()){
            ...
            if(lat_saya < 0.001 && lon_saya < 0.001) {
                ...
                double longitude2 = 39.826209;
                double longitude1 = lon_saya;
                double latitude2 = Math.toRadians(21.422507);
